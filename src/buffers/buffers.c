...
ALIGNED16 u8 gCostumeYAY0Heap[2][COSTUME_HEAP_YAY0_SIZE]; // Double buffer this
ALIGNED16 u8 gCostumeGeoHeap[COSTUME_HEAP_GEO_SIZE];
ALIGNED16 u8 gCostumePoolBuffer[COSTUME_POOL_BUFFER_SIZE];
ALIGNED16 struct AllocOnlyPool gCostumeAllocPool;
