...
const LevelScript level_main_scripts_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO,                      mario_ref_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIOS_METAL_CAP,           marios_metal_cap_ref_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIOS_WING_CAP,            marios_wing_cap_ref_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIOS_CAP,                 marios_cap_ref_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_UNSAFE_MARIOS_CAP,          marios_cap_geo),          // NOTE: These loads MUST be deleted if moving cap models into costume segments!
    LOAD_MODEL_FROM_GEO(MODEL_UNSAFE_MARIOS_METAL_CAP,    marios_metal_cap_geo),    // NOTE: These loads MUST be deleted if moving cap models into costume segments!
    LOAD_MODEL_FROM_GEO(MODEL_UNSAFE_MARIOS_WING_CAP,     marios_wing_cap_geo),     // NOTE: These loads MUST be deleted if moving cap models into costume segments!
    LOAD_MODEL_FROM_GEO(MODEL_UNSAFE_MARIOS_CAP_EXTERNAL, marios_cap_external_geo), // NOTE: These loads MUST be deleted if moving cap models into costume segments!
